    ...
    <div style={{ minHeight: '100vh', background: '#0c0c0b', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: isMobile ? '24px 16px' : '40px 20px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <h2 style={{ fontSize: isMobile ? '20px' : '22px', fontFamily: 'Georgia, serif', fontStyle: 'italic', color: '#f0ede6', marginBottom: 6 }}>Welcome back</h2>
          <p style={{ fontSize: '13px', color: 'rgba(240,237,230,0.35)' }}>Sign in to continue</p>
        </div>
        ...
        <div style={{ marginTop: 28, textAlign: 'center' }}>
          <Link href="/sign-up" style={{ color: '#d4a843', fontSize: '13px', textDecoration: 'none' }}>
